 ...
 *
 *      - manage content info.
 *          - show loader if redux town data is pending
 *          - show error if redux town data is error
 *          - show data if redux town data is success
 */
  ...
  it('DataManager Snapshot', () => {
    expect(
      renderRedux(
        ...
        {
          initialState: { town: { pending: false, error: false } },
        }
      ).baseElement
    ).toMatchSnapshot();
    ...
    expect(
      renderRedux(
        ...
        {
          initialState: { town: { pending: true, error: false } },
        }
      ).baseElement
    ).toMatchSnapshot();
    ...
    expect(
      renderRedux(
        ...
        {
          initialState: { town: { pending: false, error: true } },
        }
      ).baseElement
    ).toMatchSnapshot();
  });
